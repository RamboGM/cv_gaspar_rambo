...
export default function FloatingWhatsappButton() {
  ...
  const containerBaseClasses =
    "fixed bottom-6 right-4 z-40 flex max-w-xs flex-col gap-3 rounded-3xl border border-white/20 bg-[#0f766e]/15 p-4 text-white shadow-[0_20px_50px_rgba(15,118,110,0.3)] backdrop-blur-xl transition-all duration-500 ease-out sm:bottom-8 sm:right-8";
  ...
  return (
    <aside
      ...
      role="dialog"
    >
      <p className="text-xs font-light uppercase tracking-[0.2em] text-white/90">
      ...
      <a
        ...
        className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366]/90 text-[#0f172a] shadow-[0_12px_30px_rgba(37,211,102,0.35)] transition-transform hover:-translate-y-0.5 hover:bg-[#1ebe5c] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366]"
